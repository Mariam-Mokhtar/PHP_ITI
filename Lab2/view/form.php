    ...
    <section class="container my-5">
        <div class="row mx-auto p-4 bg-white shadow-lg rounded-4 w-75 fw-bold" style="color:#A3C7D6">
            ...
            <form method="post" action="index.php">
                ...
                <input id="submit" type="submit" value="Send email" class="btn text-white fw-bold"style="background-color:#A3C7D6"/>
                <input id="clear"  type="reset" value="clear form" class="btn text-white fw-bold"style="background-color:#A3C7D6"/>
                        </form>
        </div>
    </section>
