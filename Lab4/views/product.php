...
<head>
    ...
    <style>
        body {
            background: linear-gradient(45deg, #8D7B68 40%, #C8B6A6 60%);
        ...
        .rigthDiv{
            background: linear-gradient(90deg, #C8B6A6 40%, #F1DEC9 60%);
            background-attachment: fixed;
        }
        ...
        .details, .pag-btn:hover{
            background-color: #8D7B68 !important;
            color: white !important;
        }

        .details:hover,.pag-btn {
    ...
    <div class="wrapper container mt-5 mb-5 ">
        <div class="box card border-0 rounded-4 shadow-lg">
            ...
            if ($item["discontinued"] == 1) {
                echo '<div class="ribbon text-center">10%<br>OFF</div>';
            }
            ?>
            <div class="row g-0">
                <div class="col-md-5 py-4 d-flex justify-content-center">
                    <?php
                    $image_url = "/iti_php/Lab4/images/" . $item['photo'];
                    ?>
                ...
                <div class="col-md-3 py-4 px-4 rigthDiv">
                    <div class="mb-0">
                        <p id="category"><?php echo $item['category'] ?></p>
                    </div>
                    <div class="mt-2 mb-5">
                    ...
                    <a id="all_btn" class="btn btn-sm  text-white d-inline px-5 details mt-4" type="button" href="http://localhost/iti_php/Lab4">Show All Products</a>
